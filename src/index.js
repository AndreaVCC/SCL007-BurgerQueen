...
import './index.css'; // css general, que afecta a todao el cuerpo de la aplicacion

import App from './App';
import * as serviceWorker from './serviceWorker'; // para applicaciones que se encargan de simular datos de manera local del pc (en caso de que se pierda net por un rato)
...
ReactDOM.render(<App />, document.getElementById('root')); // render permite a react  pintar la interfaz en pantalla, renderiza la aplicacion que hemos escrito en App.js
